 ...
 ">
  ...
  color: #333;">
        ...
        <div style="padding: 30px;">
            ...
            <div>Выполнен запрос на восстановление доступа личного кабинета.</div>
            <div>Для подтверждения перейдите по ссылке ниже:</div>
            <div>
                <a href="{{ $link }}">
                    {{ $link }}
                </a>
            ...
            <div style="margin-top: 20px;">Если вы не запрашивали восстановление доступа, просто проигнорируйте это
                письмо.</div>
